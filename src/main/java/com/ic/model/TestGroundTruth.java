...
public class TestGroundTruth {
    ...
    public TestGroundTruth(String image, int type) {
        this.image = image;
        this.type = type;
    }
    public TestGroundTruth() {
    }

    public TestGroundTruth(String image) {
        this.image = image;
    }
    ...
    // CSV行转换构造函数
    public TestGroundTruth(String[] csvRow) {
        if (csvRow.length < 10) {
